...
class CatalogTest {
    public CatalogItem catalogItem1 = new CatalogItem("R-1", 300,
            List.of(new AudioFeatures("Night Visions", 185,Arrays.asList("Dan Raynolds"), Arrays.asList("Imagine Dragons")),
    ...
    public CatalogItem catalogItem2 = new CatalogItem("R- 2", 300,
            List.of(new PrintedFeatures("Harry Potter", 500, Arrays.asList("J.K. Rowling"))
    ));


    public CatalogItem catalogItem3 = new CatalogItem("R-3", 300,
            List.of(new AudioFeatures("Californication", 100, Arrays.asList("Flea"), Arrays.asList("RHCP"))
    ));
